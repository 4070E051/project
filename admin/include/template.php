...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="1" class="graybox">
  ...
  <tr>
    <td width="150" valign="top" class="navArea"><p>&nbsp;</p>
      <a href="<?php echo WEB_ROOT; ?>admin/" class="leftnav">首頁</a> 
	  <a href="<?php echo WEB_ROOT; ?>admin/category/" class="leftnav">類別管理</a>
	  <a href="<?php echo WEB_ROOT; ?>admin/product/" class="leftnav">產品管理</a> 
	  <a href="<?php echo WEB_ROOT; ?>admin/user/" class="leftnav">會員管理</a> 
	  <a href="<?php echo $self; ?>?logout" class="leftnav">登出</a>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>&nbsp;</p></td>
