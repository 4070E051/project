...
<form action="processProduct.php?action=addProduct" method="post" enctype="multipart/form-data" name="frmAddProduct" id="frmAddProduct">
 <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="entryTable">
  ...
  <tr> 
   <td width="150" height="36" class="label">價格</td>
 ...
 <p align="center"> 
  <input name="btnModifyProduct" type="button" id="btnModifyProduct" value="修改" onClick="window.location.href='index.php?view=modify&productId=<?php echo $productId; ?>';" class="box">
  &nbsp;&nbsp;
