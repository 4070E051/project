...
<form action="processProduct.php?action=modifyProduct&productId=<?php echo $productId; ?>" method="post" enctype="multipart/form-data" name="frmAddProduct" id="frmAddProduct">
 <p align="center" class="formTitle">修改商品</p>
...
?>    
 ...
 <p align="center"> 
  <input name="btnModifyProduct" type="button" id="btnModifyProduct" value="修改" onClick="checkAddProductForm();" class="box">
